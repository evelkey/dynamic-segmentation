...
tf.app.flags.DEFINE_string('log_dir', "/mnt/permanent/Home/nessie/velkey/logs/sentence/", """logging directory root""")
...
def train_convlstm_model(unit_list, kernel_sizes, output_channels):
    ...
    NAME = "sentence_lstm_" + re(str(unit_list)) + "_conv_channel_" + re(str(output_channels)) + "_kernels_" + re(
        str(kernel_sizes))
